...
from entregaalpes.modulos.envios.dominio.objetos_valor import NombreAero, Odo, Leg, Segmento, Itinerario, CodigoIATA
from entregaalpes.modulos.envios.dominio.entidades import Proveedor, Aeropuerto, Reserva
from entregaalpes.modulos.envios.dominio.eventos import ReservaAprobada, ReservaCancelada, ReservaAprobada, ReservaPagada, ReservaCreada, EventoReserva

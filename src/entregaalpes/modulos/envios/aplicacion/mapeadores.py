...
from entregaalpes.modulos.envios.dominio.entidades import Reserva, Aeropuerto
from entregaalpes.modulos.envios.dominio.objetos_valor import Itinerario, Odo, Segmento, Leg
